...
export default function Loading(props) {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backdropFilter: 'blur(6px)', flexDirection: 'column' }}>
            ...
            <div style={{ flexGrow: "1", }}></div>
            <p style={{ marginTop: "auto", paddingBottom: "20px", fontSize: '35px', color: 'white', fontFamily: "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif" }}> 🍗 Foody - "Get your meal"✨</p>
        </div>
    )
}